...
<div {id} class={className}>
	...
	{:else}
		...
		>
			<div
				class="w-full min-w-0 max-w-full font-medium flex items-center gap-1.5 {isActive
					? 'shimmer'
					: ''}"
			>
				<!-- Status icon -->
			...
			<div transition:slide={{ duration: 300, easing: quintOut, axis: 'y' }}>
				...
				>
					{#if args}
						...
						<div>
							<div
								class="text-[0.625rem] uppercase tracking-wider font-medium text-gray-400 dark:text-gray-500 mb-1.5 px-1"
							>
								{$i18n.t('Input')}
							</div>
